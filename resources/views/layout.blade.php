...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('front/img/movie-icon-png.jpg') }}" type="image/x-icon">
    <title>POS</title>
    <!-- Font Awesome Script -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="position: relative;">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <form class="form-inline my-2 my-lg-0" action="<?= '' ?>" style="position: relative;"
                ...
                <div id="popup-search" style="position: absolute;top:40px;left:0;right:0;z-index: 1;"
    ...
    <div id="main-wrap" class="d-flex">
        <div id="sidebar" class="p-3" style="flex:0.15">
            <div class="sidebar-section-group border-top border-bottom border-light">
                ...
                <a href="/kategori"><p class="sidebar-item mb-0">Kategori</p></a>
            </div>
