    ...
    <script type="module">
        ...
        (async () => {
            ...
            let filterPercentage = (el, inc = 1) => {
                ...
                selisihRange = Math.round(selisihRange * Math.pow(10, 10)) / Math.pow(10,
                    10) // Untuk pembulatan, agar menghilangkan desimal yang terlalu panjang
                let incPer10 = Math.round((selisihRange / 10) * Math.pow(10, 10)) / Math.pow(10,
                    10) // Untuk pembulatan, agar menghilangkan desimal yang terlalu panjang
            ...
            let dataSample = {
                series: [{
                        name: 'Category',
                        values: ['Last=Low', 'Last=High', 'Diatas 10%', 'Diatas 20%', 'Diatas 30%',
                            'Diatas 50%', 'Diatas 60%', 'Diatas 70%', 'Diatas 80%', 'Diatas 90%'
                        ]
                    },
                    {
                        name: 'Value',
